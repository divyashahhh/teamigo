...
export default function BottomNavigation({ userRole, currentTab = 'home' }: BottomNavigationProps) {
  const memberTabs: TabItem[] = [
    { id: 'home', label: 'Profile', icon: require('@/assets/icons/homee.png'), route: '../(member)/profile' },
  ...
  const hostTabs: TabItem[] = [
    { id: 'home', label: 'Portal', icon: require('@/assets/icons/homee.png'), route: '../(host)/portal' },
