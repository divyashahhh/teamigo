...
function TabIcon({ focused, source, isCenter }: { focused: boolean; source: any; isCenter?: boolean }) {
...
export default function TabLayout() {
  return (
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <TabIcon focused={focused} source={icons.announce} />
          ),
        }}
      />
      <Tabs.Screen
  ...
  options={{
    tabBarIcon: ({ focused }) => (
      ...
      >
        <Image
          source={require('@/assets/icons/high-five.png')}
          style={{
            width: 28,
            height: 28,
            tintColor: '#2BB3B1',
...
/>
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <TabIcon focused={focused} source={icons.merch} />
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <TabIcon focused={focused} source={icons.calendar} />
          ),
        }}
      />
    </Tabs>
